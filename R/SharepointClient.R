#' sharepoint_client is a constructor for class that performs any operations with
...
#'  sharepoint_client$do("GET", "/api/2.1/unity-catalog/catalogs")
#'
#' @export
sharepoint_client <- function(profile = NULL, host = NULL, token = NULL, config_file = NULL) {
