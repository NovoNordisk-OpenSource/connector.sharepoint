...
provides a common interface for interacting with various data sources. The connector.sharepoint package extends the {connector} package to support Microsoft SharePoint sites.
...
site. By default, token is retrieved from the using `AzureAuth::get_token()`
