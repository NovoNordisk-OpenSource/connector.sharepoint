---
title: "connector_sharepoint"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{connector_sharepoint}
...
db$output$upload_cnt(tmp_file, "tmeanallmtcars.docx")
...
db$output$write_cnt(fsetosa$data, "fsetosa.csv")
db$output$write_cnt(fsetosa, "fsetosa.rds")

tmp_file <- tempfile(fileext = ".png")
ggsave(tmp_file, fsetosa)
db$output$upload(tmp_file, "fsetosa.png")
